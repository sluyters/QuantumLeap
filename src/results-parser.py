...
for dataset in results:
    ...
    for recognizer in data:
        ...
        for benchmark in benchmarks:
            ...
            plt.xlabel('Predicted', labelpad=10, fontsize=14, fontweight='bold') 
            plt.ylabel('Actual', labelpad=10, fontsize = 14, fontweight='bold') 
            ...
            for index, line in enumerate(confusionMatrix):
                correct = line[index]
                accuracy = (correct/nRepetitions) * 100
