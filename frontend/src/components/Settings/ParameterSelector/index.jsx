...
function ParameterSelector({ templates, values, onChange, level, path, value, minParams, maxParams, params, settings }) {
  ...
  selectedParams.forEach((param, paramIndex) => {
    ...
    const handleSettingChange = function(path, value) {
      ...
      onChange(paramSelectorPath, newParamSelectorValue);
    }
      ...
      <Accordion key={key} defaultExpanded={true}>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Box width={1}>
            ...
            <IconButton onClick={handleParamDeletion} size="large">
              <DeleteIcon/>
            </IconButton>
